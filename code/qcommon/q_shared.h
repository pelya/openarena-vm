...
enum { NAT_TYPE_PROCESSING_INIT, NAT_TYPE_PROCESSING_GETMYADDR, NAT_TYPE_PROCESSING_HEARTBEAT, NAT_TYPE_PROCESSING_FAKEREG, NAT_TYPE_PROCESSING, NAT_TYPE_GOOD, NAT_TYPE_BAD };
